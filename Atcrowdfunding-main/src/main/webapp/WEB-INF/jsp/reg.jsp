...
<nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
    <div class="container">
        <div class="navbar-header">
            <div><a class="navbar-brand" href="index.html" style="font-size:32px;">众筹网站-创意产品众筹平台</a></div>
        </div>
    </div>
</nav>
...
<div class="container">
    ...
    <form class="form-signin" role="form">
        ...
        <div class="form-group has-success has-feedback">
            ...
            <input type="hidden" class="form-control" id="fusername" name="username" placeholder="请输入登录账号" autofocus>
            <input type="hidden" class="form-control" id="fauthstatus" name="authstatus" value="0" placeholder="请输入登录账号"
                   autofocus>
        ...
        <a class="btn btn-lg btn-success btn-block" onclick="doRegist()" id="btn_regist"> 注册</a>
    </form>
</div>
...
<script>
    function doRegist() {
        ...
        let fusername = $("#fusername");
        let fauthstatus = $("#fauthstatus");
        ...
        $.ajax({
            ...
            data: {
                ...
                email: femail.val(),
                usertype: ftype.val(),
                username: floginacct.val(),
                authstatus: fauthstatus.val(),
            },
            url: "${APP_PATH}/doRegist.do",
            beforeSend: function () {
