                ...
                <div class="panel-body">
                    <form id="updateForm">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="name" value="${advert.name }"
                                   placeholder="请输入广告名称">
                        </div>
                        <div class="form-group">
                            <label for="iconpath">图片名称</label>
                            <input type="text" class="form-control" id="iconpath" value="${advert.iconpath }"
                                   placeholder="请输入广告图片">
                        </div>
                        <div class="form-group">
                            <label for="url">广告地址</label>
                            <input type="text" class="form-control" id="url" value="${advert.url }"
                                   placeholder="请输入广告地址">
                        </div>
                        <div class="form-group">
                            <label for="status">广告状态</label>
                            <input type="text" class="form-control" id="status" value="${advert.status }"
                                   placeholder="更改状态">
                        </div>
                        <div class="form-group">
                            <label for="userid">用户id</label>
                            <input type="text" class="form-control" id="userid" value="${advert.status }"
                                   placeholder="用户id">
                        </div>
