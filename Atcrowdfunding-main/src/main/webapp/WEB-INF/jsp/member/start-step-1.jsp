        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            <div class="container">
                <div class="navbar-header">
                    <a class="navbar-brand" href="index.html" style="font-size:32px;">众筹网站-创意产品众筹平台</a>
                </div>
            ...
            <div class="col-md-12 column">
                <div class="panel panel-default" >
                                ...
                                <div class="col-md-12 column">
                                    ...
                                    <form class="form-horizontal">
                                            ...
                                            <div class="col-sm-10">
                                                <ul style="list-style:none;padding-left:0;">
                                                    <li style="margin:10px 0">[手机]
                                                        <span class="label-txt">手机</span> <span class="label-txt">快充</span> <span class="label-txt">品牌</span> <span class="label-txt">电池</span> <span class="label-txt">内核</span> <span class="label-txt">手机壳</span>
                                                    </li>
                                                    <li style="margin:10px 0">[数码]
                                                        <span class="label-txt">VR</span> <span class="label-txt">3D眼镜</span> <span class="label-txt">投影设备</span> <span class="label-txt">传统胶卷</span> <span class="label-txt">镜片</span> <span class="label-txt">单反</span>
                                                    </li>
                                                    <li style="margin:10px 0">[电脑]
                                                        <span class="label-txt">CPU</span> <span class="label-txt">主板</span> <span class="label-txt">内存</span> <span class="label-txt">显示器</span> <span class="label-txt">鼠标</span> <span class="label-txt">键盘</span>
                                                    </li>
                                                </ul>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" style="width:100px;" id="money" name="money" >
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input type="text" class="form-control" style="width:100px;" id="day" name="day" >
                    ...
                    <div class="panel-footer" style="text-align:center;">
                        <button type="button" class="btn  btn-warning btn-lg" id="step1Btn">下一步</button>
                    </div>
                </div>
            </div>
        </div>
...
<script>
    $(function () {
       $("#step1Btn").click(function () {
           $.ajax({
               type : "POST",
               url  : "${APP_PATH}/member/saveProject.do",
               data : {
                   name : $("#name").val(),
                   remark  : $("#remark").val(),
                   money      : $("#money").val(),
               ...
               success : function(result) {
                   if ( result.success ) {
                       window.location.href="${APP_PATH}/member/start-step-2.htm";
                   } else {
