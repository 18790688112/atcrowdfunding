                    ...
                    <ul class="nav navbar-nav">
                        <li class="dropdown">
                            <a href="#" class="dropdown-toggle" data-toggle="dropdown"><i
                                    class="glyphicon glyphicon-user"></i> ${sessionScope.loginMember.username }<span
                                    class="caret"></span></a>
                ...
                <div class="panel panel-default">
                                            ...
                                            <div class="col-md-12 column">
                                                <form class="form-horizontal">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="inlineRadioOptions" id="type"
                                                                       value="0"> 实物回报
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" name="inlineRadioOptions" id="type1"
                                                                       value="1"> 虚拟物品回报
                                                            </label>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <input type="text" class="form-control"
                                                                   style="width:100px;display:inline" id="count">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="inlineRadioOptions2"
                                                                       id="inlineRadio1" value="option1"> 不限购
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" name="inlineRadioOptions2"
                                                                        value="option2"> 限购
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   style="width:100px;display:inline" id="signalpurchase">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="inlineRadioOptions1"
                                                                       id="invoice1" value="0"> 不可开发票
                                                            </label>
                                                            <label class="radio-inline">
                                                                <input type="radio" name="inlineRadioOptions1"
                                                                       id="invoice" value="1">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            <input type="text" class="form-control"
                                                                   style="width:100px;display:inline" id="rtndate">
                    ...
                    <div class="panel-footer" style="text-align:center;">
                        <button type="button" class="btn  btn-default btn-lg"
                                onclick="window.location.href='${APP_PATH}/member/start-step-1.htm'">上一步
                        </button>
                        <button type="button" class="btn  btn-warning btn-lg" id="step2Btn">下一步</button>
                        <a class="btn"> 预览 </a>
                    </div>
                </div>
            </div>
...
<script>
    ...
    $("#step2Btn").click(function () {
        alert(1)
        <%--onclick="window.location.href='${APP_PATH}/member/start-step-3.htm'"--%>
        $.ajax({
            type: "POST",
            url: "${APP_PATH}/member/saveReturn.do",
            data: {
                type: $("#type").val(),
                supportmoney: $("#supportmoney").val(),
                content: $("#content").val(),
                count: $("#count").val(),
            ...
            success: function (result) {
                if (result.success) {
                    window.location.href = "${APP_PATH}/member/start-step-3.htm";
                } else {
