...
public class DispatcherController {
    ...
    public Object doRegist(Member member,HttpSession session, HttpServletResponse response) {
...
//            member.setLoginacct((String) paramMap.put("loginacct", loginacct));
//            member.setUserpswd((String) paramMap.put("userpswd", MD5Util.digest(userpswd)));
//            member.setEmail((String) paramMap.put("email", email));
//            member.setUsertype((String) paramMap.put("usertype", usertype));
//            member.setUsername((String) paramMap.put("loginacct", loginacct));
